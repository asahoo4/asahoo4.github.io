  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-[#eee]">
        <div className="max-w-[1000px] mx-auto px-6 h-[60px] flex items-center justify-between">
          <a
            href="#"
      ...
      <div className="border-t border-[#eee] mt-4">
        <div className="max-w-[1000px] mx-auto px-6 py-16 flex flex-col items-center">
